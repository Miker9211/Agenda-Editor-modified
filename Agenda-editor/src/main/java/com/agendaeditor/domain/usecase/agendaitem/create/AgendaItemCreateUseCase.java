package com.agendaeditor.domain.usecase.agendaitem.create;
...
@AllArgsConstructor
public class AgendaItemCreateUseCase implements UseCase<AgendaItemCommand, AgendaItemResponse> {
    ...
    public AgendaItemResponse execute(AgendaItemCommand command) throws JsonProcessingException {
        return service.createAgendasItem(buildDto(command))
                .map(agendaItemDTO ->
